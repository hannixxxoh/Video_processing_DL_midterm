...
def main():
    ...
    #         scores = []
    #         for idx in range(frame_n-1):
    #             dataset = DummyDataset(opt_frame_files[idx], opt_frame_files[idx+1],
    #                                 'img', 'img',
    ...
    #         opt_scores.append(sum(scores)/len(scores))
        
    #     CLIPF_score_dict[optflow] = sum(opt_scores) / len(opt_scores)
